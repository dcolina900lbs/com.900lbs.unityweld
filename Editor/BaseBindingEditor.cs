...
namespace UnityWeld.Editor
{
    ...
    /// </summary>
    public abstract class BaseBindingEditor : UnityEditor.Editor
    {
        ...
        protected static bool ShouldShowAdapterOptions(string adapterId, out Type adapterType)
        {
            ...
            return adapterType != typeof(ScriptableObject) && adapterType != null;
        }
        ...
        protected void ShowAdapterOptionsMenu(
            ...
            Action<ScriptableObject> propertyValueSetter,
            ScriptableObject currentPropertyValue,
            float fadeAmount
        )
        {
            if (EditorGUILayout.BeginFadeGroup(fadeAmount))
            {
                ...
                var newAdapterOptions = (ScriptableObject)EditorGUILayout.ObjectField(
                    label,
